...
public class ConcurrencyUtils
{
	...
	private static class CustomThreadFactory implements ThreadFactory
	{
		...
		{
			Thread t = CustomThreadFactory.defaultFactory.newThread(r);
	...
	private static int						NTHREADS						= ConcurrencyUtils
																					.prevPow2(ConcurrencyUtils
	...
	{
		return ConcurrencyUtils.THREADS_BEGIN_N_1D_FFT_2THREADS;
	}
	...
	{
		return ConcurrencyUtils.THREADS_BEGIN_N_1D_FFT_4THREADS;
	}
	...
	{
		return ConcurrencyUtils.THREADS_BEGIN_N_2D;
	}
	...
	{
		return ConcurrencyUtils.THREADS_BEGIN_N_3D;
	}
	...
	{
		ConcurrencyUtils.THREADS_BEGIN_N_2D = 65536;
		ConcurrencyUtils.THREADS_BEGIN_N_3D = 65536;
	}
	...
	{
		ConcurrencyUtils.THREADS_BEGIN_N_1D_FFT_2THREADS = 8192;
		ConcurrencyUtils.THREADS_BEGIN_N_1D_FFT_4THREADS = 65536;
	}
	...
	{
		ConcurrencyUtils.NTHREADS = ConcurrencyUtils.prevPow2(n);
	}
	...
	{
		if (n < 512)
			ConcurrencyUtils.THREADS_BEGIN_N_1D_FFT_2THREADS = 512;
		else
			ConcurrencyUtils.THREADS_BEGIN_N_1D_FFT_2THREADS = n;
	}
	...
	{
		if (n < 512)
			ConcurrencyUtils.THREADS_BEGIN_N_1D_FFT_4THREADS = 512;
		else
			ConcurrencyUtils.THREADS_BEGIN_N_1D_FFT_4THREADS = n;
	}
	...
	{
		ConcurrencyUtils.THREADS_BEGIN_N_2D = n;
	}
	...
	{
		ConcurrencyUtils.THREADS_BEGIN_N_3D = n;
	}
	...
	{
		return ConcurrencyUtils.THREAD_POOL.submit(task);
	}
